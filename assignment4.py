...
if __name__ == "__main__":
    ...
    for i in range(1, n + 1):
        process_number = "P" + str(i)
        arrival_time = int(input(f"Enter arrival time for {process_number}: "))
        burst_time = int(input(f"Enter burst time for {process_number}: "))
        priority = int(input(f"Enter priority for {process_number}: "))
        processes.append([process_number, arrival_time, burst_time, priority])
